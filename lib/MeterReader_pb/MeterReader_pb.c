...
const pb_field_t MeterReader_Settings_fields[8] = {
    ...
    PB_FIELD(  5, UINT32  , REQUIRED, STATIC  , OTHER, MeterReader_Settings, threshold, communicationChannel, 0),
    PB_FIELD(  6, UINT32  , REQUIRED, STATIC  , OTHER, MeterReader_Settings, hysteresis, threshold, 0),
